/*
    ...
    - objetivo 1 - quando clicar no botão de troca do tema, adicionar a classe modo-escuro no body pra que os estilos do modo escuro sejam aplicados e mudar a imagem pra lua
        - passo 1 - pegar no JS o elemento HTML correspondente no botão  de troca de tema
        - passo 2 - dar um jeito de pegar mo JS o elemento HTML correspondente ao body
        - passo 3 - dar um jeito de identificar o clique do usuário no botão de troca de tema
        - passo 4 - adicionar a classe modo-escuro no body
        - passos 5 - trocar a imagem do botão de alterar tema pra lua
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
        ...
        - passo 7 - remover a classe do modo modo-escuro do body
